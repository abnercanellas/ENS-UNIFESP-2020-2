...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div id="menu" class="bg-a1 shadow-sm sidebar-sticky  fixed-left">
                    <?php
                        ...
                        <div id="dConsulta">
                            <form class="m-0" action="" method="POST">
                                ...
                                <div class="d-grid d-md-flex justify-content-md-end">
                                    <input class="btn btn-primary mt-3 mb-5" type="submit"  value="Consultar" name="formConsulta" id="idformConsulta" style="display: none">
                                </div>
                            </form>
                            <ul>
